    ...
    return (
        <>
            <div className="container" style={{color: props.mode ===  'light'?'#010621':'white'}}>
                ...
                <button className="btn btn-primary mx-5 my-1" onClick={handlelowClick}>Convert to Lowercase</button>
                <button className="btn btn-primary mx-5 my-1" onClick={handleClearClick}>Clear Text</button>
            </div>
